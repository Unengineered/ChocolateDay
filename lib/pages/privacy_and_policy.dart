            ...
            child: Padding(
              ...
              child: SingleChildScrollView(
                child: Column(
                  ...
                  children: [
                    Center(child: buildChild('Last updated: April 28, 2021')),
                    buildChild(
...
We use Your Personal data to provide and improve the Service. By using the Service, You agree to the collection and use of information in accordance with this Privacy Policy. This Privacy Policy has been created with the help of the Privacy Policy Generator.'''),
                    ...
                    buildOneWordBold('''• Account ''',
                        '''means a unique account created for You to access our Service or parts of our Service.'''),
                    buildOneWordBold('''• Company''',
                        '''(referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to Cultural Council VESIT, Chembur.'''),
                    buildOneWordBold('''• Cookies ''',
                        '''are small files that are placed on Your computer, mobile device or any other device by a website, containing the details of Your browsing history on that website among its many uses.'''),
                    buildOneWordBold(
                        '''• Country ''', '''refers to: Maharashtra, India'''),
                    buildOneWordBold('''• Device ''',
                        '''means any device that can access the Service such as a computer, a cellphone or a digital tablet.'''),
                    buildOneWordBold('''• Personal Data ''',
                        '''is any information that relates to an identified or identifiable individual.'''),
                    buildOneWordBold(
                        '''• Service ''', '''refers to the Website.'''),
                    buildOneWordBold('''• Service Provider ''',
                        '''means any natural or legal person who processes the data on behalf of the Company. It refers to third-party companies or individuals employed by the Company to facilitate the Service, to provide the Service on behalf of the Company, to perform services related to the Service or to assist the Company in analyzing how the Service is used.'''),
                    buildOneWordBold('''• Usage Data ''',
                        '''refers to data collected automatically, either generated by the use of the Service or from the Service infrastructure itself (for example, the duration of a page visit).'''),
                    buildOneWordBold('''• Website ''',
                        '''refers to Chocolate Day, accessible from chocolateday.in'''),
                    buildOneWordBold('''• You ''',
...
We may also collect information that Your browser sends whenever You visit our Service or when You access the Service by or through a mobile device.'''),
                    ...
                    buildOneWordBold('''• Cookies or Browser Cookies. ''',
                        '''A cookie is a small file placed on Your Device. You can instruct Your browser to refuse all Cookies or to indicate when a Cookie is being sent. However, if You do not accept Cookies, You may not be able to use some parts of our Service. Unless you have adjusted Your browser setting so that it will refuse Cookies, our Service may use Cookies.'''),
                    buildOneWordBold('''• Flash Cookies. ''',
...
We use both Session and Persistent Cookies for the purposes set out below:'''),
                    buildOneWordBold('''• Necessary / Essential Cookies''',
...
Purpose: These Cookies identify if users have accepted the use of cookies on the Website.'''),
                    buildOneWordBold('''• Functionality Cookies''',
                        '''\nType: Persistent Cookies
Administered by: Us
Purpose: These Cookies allow us to remember choices You make when You use the Website, such as remembering your login details or language preference. The purpose of these Cookies is to provide You with a more personal experience and to avoid You having to re-enter your preferences every time You use the Website.'''),
                    ...
                    buildOneWordBold('''• To manage Your requests: ''',
                        '''To attend and manage Your requests to Us.'''),
                    buildOneWordBold('''• For business transfers: ''',
                        '''We may use Your information to evaluate or conduct a merger, divestiture, restructuring, reorganization, dissolution, or other sale or transfer of some or all of Our assets, whether as a going concern or as part of bankruptcy, liquidation, or similar proceeding, in which Personal Data held by Us about our Service users is among the assets transferred.'''),
                    buildOneWordBold('''• For other purposes: ''',
                        '''We may use Your information for other purposes, such as data analysis, identifying usage trends, determining the effectiveness of our promotional campaigns and to evaluate and improve our Service, products, services, marketing and your experience.'''),
                    buildChild(
                        '''We may share Your personal information in the following situations:'''),
                    buildOneWordBold('''• With Service Providers: ''',
                    ...
                    buildOneWordBold('''• With Affiliates: ''',
                    ...
                    buildOneWordBold('''• With business partners: ''',
                        '''We may share Your information with Our business partners to offer You certain products, services or promotions.'''),
                    buildOneWordBold('''• With other users: ''',
                    ...
                    buildOneWordBold('''• With Your consent:''',
...
You are advised to review this Privacy Policy periodically for any changes. Changes to this Privacy Policy are effective when they are posted on this page.'''),
  ...
  RichText buildOneWordBold(String bold, String normal) {
    return new RichText(
      ...
      text: new TextSpan(
        ...
        children: <TextSpan>[
          new TextSpan(
              text: bold, style: new TextStyle(fontWeight: FontWeight.w600)),
  ...
  Text buildSubHeading(String val) {
    return Text(
      val,
      style: TextStyle(
  ...
  Text buildSubHeading2(String val) {
    return Text(
      val,
      style: TextStyle(
